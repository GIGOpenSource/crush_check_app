export default {
  ...
  common: {
    ...
    vipServiceAgreement: 'VIP Service Agreement',
 ...
 poster: {
  ...
  mbti: {
    ...
    testTypeConsistentWithInviter: 'Test type will be consistent with the inviter',
    ...
    vipExclusiveTitle: 'VIP Exclusive - Become a member to view results',
    vipPrivileges: 'VIP Privileges:',
    singleVipBenefit1: 'Unlimited access to 3 core question types, review personality status anytime',
    singleVipBenefit2: 'Full access to all other module features',
    doubleSimpleReport: 'Double Simple Version MBTI Test Report',
    doubleMajorReport: 'Double Professional Version MBTI Test Report',
    doubleAdvancedReport: 'Double Advanced Version MBTI Test Report',
    packageIncludes: 'Package Includes:',
    doubleBenefit1: 'Multi-dimensional compatibility analysis: lover, family, friend relationship perspectives',
    doubleBenefit2: 'One person unlocks, both parties can view, share deep relationship analysis',
    doubleBenefit3: 'Includes exclusive individual analysis reports for both parties, comprehensive self-awareness',
    payVipPrefix: 'Pay',
    ...
    payUnlockDoubleSuffix: 'yuan to unlock double version test',
    // test.vue page
    mbtiTest: 'MBTI Test',
    mbtiDoubleTest: 'MBTI Double Version Test',
    viewNow: 'View Now',
    bothCompleted: 'Both parties have completed answering',
    temporarilyUnpayable: 'Temporarily unavailable for payment',
    otherPaying: 'The other party is paying',
    applePayChannelNotFound: 'Apple Pay channel not found',
