 ...
 tarot_input_question_title: "输入你心中的问题",
  ...
  choosebook: {
   ...
   mbti: {
    ...
    testTypeConsistentWithInviter: '试题类型将与邀请者保持一致',
    startTest: '开始测试',
    ...
    abandonAnswer: '放弃作答',
    continueAnswer: '继续作答',
    shareInviteMessage: '快来测超准 MBTI！\n打开「Crush Check」APP，输入我的邀请码：{inviteCode}，一起看看性格匹配度～',
    // MbtiProup 组件
    ...
    vipPrivileges: '会员特权：',
    singleVipBenefit1: '3种核心题型无次数限制，随时复盘人格状态',
    singleVipBenefit2: '其他模块功能畅玩',
    doubleSimpleReport: '双人简易版MBTI测试报告',
    doubleMajorReport: '双人专业版MBTI测试报告',
