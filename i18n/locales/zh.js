export default {
 ...
 tarot_input_question_title: "输入你心中的问题",
  ...
  mbti: {
    ...
    singleTest: '单人MBTI测试',
    singleTestDesc: '过一系列精心设计的问题，探索你的 性格类型，了解个人优势、弱点和潜在 特征',
    doubleTest: '双人匹配MBTI测试',
    doubleTestDesc: '邀请你的伙伴一起测试，生成专属 的MBTI联系匹配报告，探索你们的 相处模式',
    personalityDetail: '16人格详解',
    personalityDesc: '16型人格（MBTI）是基于荣格理论发展的人格分类 系统，通过四个维度（外向/内向、实感/直觉、思 考/情感、判断/感知）组合出16种性格类型，旨在 帮助人们了解自我、理解他人，并在职业发展、人 际关系中提供参考，每种类型有其独特的优缺点和 偏好。',
    selectTest: '选择测试',
    testContent: 'MBTI(迈尔斯-布里格斯类型指标)基于荣 格心理类型理论，通过"精力来源(E/I)、 认知方式(S/N)、决策方式(T/F)、生活方 式(J/P)"4组维度，划分出16种人格类型。 它能帮你认知自我优势、理解他人差异适 配职业选择与人际沟通，需注意本测试的 分析结果主要针对于恋爱方向的解析与建 议。 专业测试(90题以上)更具参考性，简易版 仅作探索起点，关键是用它找到舒适的相 处与成长方式。',
    simpleVersion: '28题 简易版',
    majorVersion: '93题 专业版',
    advancedVersion: '114题 进阶版',
    exitTest: '退出测试',
    doubleMatch: '双人匹配',
