 ...
 tarot_input_question_title: "输入你心中的问题",
  ...
  choosebook: {
   ...
   mbti: {
    ...
    selectTest: '选择测试',
    testContent: 'MBTI(迈尔斯-布里格斯类型指标)基于荣格心理类型理论，通过"精力来源(E/I)、 认知方式(S/N)、决策方式(T/F)、生活方式(J/P)"4组维度，划分出16种人格类型。 它能帮你认知自我优势、理解他人差异适配职业选择与人际沟通，需注意本测试的分析结果主要针对于恋爱方向的解析与建议。 专业测试(90题以上)更具参考性，简易版仅作探索起点，关键是用它找到舒适的相处与成长方式。',
