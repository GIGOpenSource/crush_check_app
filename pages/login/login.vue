			...
			<view class="agreement-section">
				<view class="agreement-checkbox" @click="toggleAgreement">
					...
					<text class="agreement-text">
						...
						<text class="link-text" @click.stop="handlePrivacyClick">《{{ $t('common.privacyPolicy')
						}}》</text>
						<text class="link-text" @click.stop="handleAgreementClick">《{{ $t('common.userAgreement')
						}}》</text>
					</text>
				</view>
			</view>
...
export default {
	...
	methods: {
		...
		handlePrivacyClick() {
			uni.navigateTo({
				url: "/pages/my/richtext?label=" + encodeURIComponent(this.$t('common.privacyPolicy')) +
					"&type=" + encodeURIComponent("privacy"),
			});
		},
		handleAgreementClick() {
			uni.navigateTo({
				url: "/pages/my/richtext?label=" + encodeURIComponent(this.$t('common.userAgreement')) +
					"&type=" + encodeURIComponent("agreement"),
			});
		},
		checkDisabled() {
		...
		async loginWithCode(message, userInfo) {
			try {
